...
class Boleto {
    ...
    private Boleto(string codBarras, DateTime dataEmissao, DateTime dataVenc, double valor){
    ...
    public override string ToString(){
        return $"{codBarras} - {dataEmissao:dd/MM/yyyy} - {dataVenc:dd/MM/yyyy} - {dataPagto:dd/MM/yyyy} - {valorBoleto:0.00} - {valorPago:0.00}";
    }
...
class Program {
    public static void Main(){
        Boleto b = new Boleto("1123", DateTime.Parse("2023-10-14"),
        DateTime.Parse("2023-05-15"), 248.45
        );
